hi. we created a crash handler: if the server crashes, it'll make everyone reconnect and restart on the last played map. this should be a lot less disruptive to the gaming experience if shit happens.
